    ...
    private void seedEventos() {
        ...
        List<Evento> eventos = List.of(
            ...
            Evento.builder()
                ...
                .hora(LocalTime.of(10, 0))
                .ubicacion("MUNA, Calle Fuente Morales 1, Santa Cruz")
                .latitud(28.4655).longitud(-16.2520)
                .categoria(arte)
                .imagenUrl(IMG_ARTE)
                .precio(new BigDecimal("5.00"))
                .build(),
            ...
            Evento.builder()
                .titulo("Exposición Fotográfica «Caminos del Teide»")
                .descripcion("Pedro González presenta 50 fotografías en gran formato sobre los senderos menos transitados del Parque Nacional del Teide. Visitas guiadas con el autor los sábados al mediodía.")
            ...
            Evento.builder()
                .titulo("Cata Guiada de Cervezas Artesanas Canarias")
                .descripcion("Recorrido degustativo por seis cervecerías artesanas del archipiélago. Cada pinta acompañada de un maridaje canario: queso ahumado, mojo rojo, almogrote y papas arrugadas. Aforo de 25 personas.")
                .fecha(LocalDate.of(2026, 6, 11))
                .hora(LocalTime.of(19, 30))
                .ubicacion("Mercado de Nuestra Señora de África, Santa Cruz")
                .latitud(28.4592).longitud(-16.2548)
                .categoria(gastro)
                .imagenUrl(IMG_GASTRO)
                .precio(new BigDecimal("15.00"))
                .build(),
            ...
            Evento.builder()
                .titulo("Teatro Familiar: «El Lago de los Cisnes para Niños»")
                .descripcion("Versión reducida del clásico de Tchaikovsky pensada para público infantil (a partir de 5 años). 50 minutos con narrador, escenografía sencilla y la Orquesta Sinfónica de Tenerife en directo.")
                .fecha(LocalDate.of(2026, 6, 14))
                .hora(LocalTime.of(12, 0))
                .ubicacion("Teatro Leal, San Cristóbal de La Laguna")
                .latitud(28.4882).longitud(-16.3157)
            ...
            Evento.builder()
                ...
                .hora(LocalTime.of(21, 30))
                .ubicacion("Sala El Tablao, Calle Castillo 17, Santa Cruz")
                .latitud(28.4671).longitud(-16.2509)
                .categoria(teatro)
                .imagenUrl(IMG_DANZA)
                .precio(new BigDecimal("18.00"))
                .build(),
            ...
            Evento.builder()
                .titulo("Mercadillo del Agricultor de Tegueste")
                .descripcion("Productores locales venden directo al público cada domingo: hortalizas de temporada, frutas tropicales, miel del Teide, quesos artesanos y vinos de la D.O. Tacoronte-Acentejo. Catas gratuitas durante la mañana.")
                .fecha(LocalDate.of(2026, 6, 21))
                .hora(LocalTime.of(9, 0))
                .ubicacion("Mercadillo del Agricultor, Tegueste")
                .latitud(28.5236).longitud(-16.3413)
                .categoria(gastro)
                .imagenUrl(IMG_GASTRO)
                .precio(BigDecimal.ZERO)
            ...
            Evento.builder()
                .titulo("Documental: «Cetáceos del Atlántico»")
                .descripcion("Estreno del documental dirigido por Mar Cabra sobre las 21 especies de cetáceos que habitan las aguas que rodean Tenerife. Coloquio con biólogos marinos del IEO al término de la proyección.")
                .fecha(LocalDate.of(2026, 6, 22))
                .hora(LocalTime.of(19, 30))
                .ubicacion("Multicines Tenerife, Centro Comercial Alcampo, La Laguna")
                .latitud(28.4889).longitud(-16.3195)
                .categoria(cine)
                .imagenUrl(IMG_CINE)
                .precio(new BigDecimal("4.00"))
            ...
            Evento.builder()
                .titulo("Feria del Libro de Santa Cruz")
                .descripcion("Más de 40 librerías y editoriales canarias se reúnen en la Rambla de Santa Cruz durante una semana. Firmas de autores, mesas redondas, cuentacuentos infantiles y descuentos directos sobre catálogo.")
                .fecha(LocalDate.of(2026, 6, 25))
                .hora(LocalTime.of(11, 0))
                .ubicacion("Rambla de Santa Cruz, Santa Cruz de Tenerife")
